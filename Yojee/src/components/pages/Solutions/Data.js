export const solution1 = {
  ...
  descript1:
    "Yojee technology powers some of the world’s largest logistics providers. Yojee SaaS platform is suitable for all, no matter how big or small your business is.",
  descript2:
    "A cloud-based platform which can be easily adopted by your logistics team in a matter of days. It also means Yojee is responsible of maintaining the software so you save costs on technical support and bug fixes.",
  descript3:
    "Yojee also offers user-friendly APIs if you are planning to integrate the solution into your existing system and a dedicated team to support you.",
  descript4:
    "We love to see our clients grow their fleet and expand their businesses. Yojee SaaS solution allows you to scale your business easily without much disruption to your day-to-day operations.",
  descript5:
    "You do not have to worry when it comes to data security as Yojee cloud-based software meets the highest data security, privacy and compliance standards.",
};
...
export const solution2 = {
  ...
  descript1:
    "With a powerful route planning software, you cut down on resources to plan deliveries and manage drivers",
  descript2:
    "Real-time ETAs and customer notifications saves your business valuable time and resource solving customer queries, while improving your customer experience",
  descript3:
...
export const solution3 = {
  ...
  descript1:
    "You can locate your drivers in a live map, and they are able to chat with you on the go, in the driver app",
  descript2:
